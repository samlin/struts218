...
public final class ContainerBuilder {
  ...
  public <T> ContainerBuilder factory(final Class<T> type, final String name,
    ...
    InternalFactory<T> internalFactory =
        new InternalFactoryImplementation2<T>(name, type, factory);
  ...
  public <T> ContainerBuilder factory(final Class<T> type, final String name,
    ...
    InternalFactory<? extends T> factory = new InternalFactoryImplementation<T>(type, name, implementation, scope);
  ...
  public Container create(boolean loadSingletons) {
    ensureNotCreated();
    created = true;// sss ´ÓContainerBuilder²úÉúContainer struts2
  ...
  private final class InternalFactoryImplementation2<T> implements InternalFactory<T> {
    private final String name;
    private final Class<T> type;
    private final Factory<? extends T> factory;

    private InternalFactoryImplementation2(String name, Class<T> type, Factory<? extends T> factory) {
      this.name = name;
      this.type = type;
  ...
  private final class InternalFactoryImplementation<T> implements InternalFactory<T> {
    private final Class<T> type;
    private final String name;
    ...
    private InternalFactoryImplementation(Class<T> type, String name, Class<? extends T> implementation, Scope scope) {
      this.type = type;
      this.name = name;
